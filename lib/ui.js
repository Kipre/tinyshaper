...
class Canvas {
    ...
    setCurrentPoint(point) {
        this.currentPoint = point;
        this.pointCallback(...this.from([point.x, point.y]),
            (point.parent == undefined) ? point.continuity : point.parent.continuity);
    }
...
class Toolbar extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            redactorView: props.redactorView,
            x: 0,
            y: 0,
    ...
    handleViewChange() {
        ...
        if (newState) {
            this.props.redactor.initialize();
        } else {
            this.props.threeDView.initialize();
        }
    ...
    render() {
        return React.createElement("div", null, React.createElement("button", {
            ...
            React.createElement("input", {
                type: "checkbox",
                disabled: (this.state.continuity == undefined),
                checked: this.state.continuity,
                onChange: () => this.setState({ ...this.state, continuity: !this.state.continuity })
            })));
    }
}
