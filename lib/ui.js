...
var DimensionInput = /*#__PURE__*/function (_React$Component) {
  _inherits(DimensionInput, _React$Component);

  var _super = _createSuper(DimensionInput);

  function DimensionInput(props) {
    var _this;

    _classCallCheck(this, DimensionInput);
  ...
  _createClass(DimensionInput, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement("div", {
        "class": "dim-input"
      }, /*#__PURE__*/React.createElement("label", null, this.props.name, " : "), /*#__PURE__*/React.createElement("input", {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        onDimensionChange: function onDimensionChange(dim) {
          _this3.handleChange(dim, 'length');
        }
      }), /*#__PURE__*/React.createElement(DimensionInput, {
        name: "Width",
        dimension: this.state.width,
        onDimensionChange: function onDimensionChange(dim) {
          _this3.handleChange(dim, 'width');
        }
      }), /*#__PURE__*/React.createElement(DimensionInput, {
        name: "Thickness",
        dimension: this.state.thickness,
        onDimensionChange: function onDimensionChange(dim) {
          _this3.handleChange(dim, 'thickness');
        }
        ...
        onDimensionChange: function onDimensionChange(dim) {
          _this3.handleChange(dim, 'y');
        },
        disabled: !this.state.pointSelected
      }), /*#__PURE__*/React.createElement(ToggleSwitch, {
        name: "Continuity",
        onChange: function onChange(e) {
          _this3.handleContinuityChange(e);
        },
...
var CvsRedactor = /*#__PURE__*/function () {
  function CvsRedactor(board) {
    var _this4 = this;

    var profile = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'z';

    _classCallCheck(this, CvsRedactor);

    _defineProperty(this, "dragok", false);
    ...
    _defineProperty(this, "rescaling", void 0);
    ...
    window.addEventListener('resize', function () {
      _this4.initialize(_this4.profile);
    });
  ...
  _createClass(CvsRedactor, [{
    ...
    key: "reconstruct",
    value: function reconstruct(board) {
      this.board = board;
    ...
    value: function onCommit(state) {
      var newBoard = _objectSpread({}, this.board);
    ...
    value: function getPoints(profile) {
      ...
      var pointsArray = this.board[profile].points.map(function (p) {
        return p.fullDest;
      });
      return pointsArray.map(function (p, i) {
        var j = p.slice();

        var _this6$to = _this6.to([j[0], j[1]]);

        var _this6$to2 = _slicedToArray(_this6$to, 2);

        j[0] = _this6$to2[0];
        j[1] = _this6$to2[1];
        return _construct(Point, _toConsumableArray(j));
      });
    }
  }, {
    key: "to",
    ...
    value: function drawProfile() {
      ...
      for (var i = 1; i < this.points.length; i += 3) {
        if (this.points[i].number > 0) {
          ...
          (_this$ctx2 = this.ctx).lineTo.apply(_this$ctx2, _toConsumableArray(points[i].pair));
...
var Point = /*#__PURE__*/function () {
  function Point(x, y, freedomX, freedomY, number) {
    ...
    _defineProperty(this, "continuity", false);
  ...
  _createClass(Point, [{
    ...
    value: function dest() {
      ...
      return [].concat(_toConsumableArray(out), _toConsumableArray(this.freedom), [this.number]);
    }
  }, {
    key: "plot",
