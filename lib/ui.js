...
var ParentPoint = /*#__PURE__*/function (_Point) {
  ...
  function ParentPoint() {
    ...
    _defineProperty(_assertThisInitialized(_this6), "continuity", false);

    _defineProperty(_assertThisInitialized(_this6), "before", null);

    _defineProperty(_assertThisInitialized(_this6), "after", null);
...
var ChildPoint = /*#__PURE__*/function (_Point2) {
  ...
  function ChildPoint() {
    ...
    _defineProperty(_assertThisInitialized(_this7), "parent", null);

    _defineProperty(_assertThisInitialized(_this7), "sibling", null);
